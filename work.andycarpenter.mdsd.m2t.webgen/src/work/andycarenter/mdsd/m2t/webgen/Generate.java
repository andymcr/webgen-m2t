 ...
 *******************************************************************************/
package work.andycarenter.mdsd.m2t.webgen;
...
public class Generate extends AbstractAcceleoGenerator {
     ...
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/work/andycarenter/mdsd/m2t/webgen/generate";
    ...
    public void registerPackages(ResourceSet resourceSet) {
        ...
        if (!isInWorkspace(work.andycarpenter.metamodel.orm.OrmPackage.class)) {
            resourceSet.getPackageRegistry().put(work.andycarpenter.metamodel.orm.OrmPackage.eINSTANCE.getNsURI(), work.andycarpenter.metamodel.orm.OrmPackage.eINSTANCE);
        }
        if (!isInWorkspace(work.andycarpenter.metamodel.waf.WafPackage.class)) {
            resourceSet.getPackageRegistry().put(work.andycarpenter.metamodel.waf.WafPackage.eINSTANCE.getNsURI(), work.andycarpenter.metamodel.waf.WafPackage.eINSTANCE);
        }
